  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed left-4 top-4 z-50 grid h-11 w-11 place-items-center rounded-lg border border-white/10 bg-white/5 text-slate-300 transition duration-200 hover:bg-white/10 md:hidden"
      >
        ...
        <div className="mt-auto pt-6">
          <div className="rounded-[22px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.06),rgba(255,255,255,0.03))] p-4 shadow-[0_16px_30px_rgba(0,0,0,0.18)]">
            ...
            <button
              ...
              className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-[14px] border border-cyan-400/20 bg-[linear-gradient(90deg,rgba(14,165,233,0.18),rgba(99,102,241,0.18))] px-4 py-3 text-[14px] font-medium text-white transition hover:brightness-110 active:scale-[0.99]"
            >
              <LogOut size={16} />
              Sign out
            </button>
